...
func (app *Config) PostRegisterPage(w http.ResponseWriter, r *http.Request) {
	...
	// generates a hash and appends it to the url to prevent url tempering
...
func (app *Config) generateManual(u data.User, plan *data.Plan) *fpdf.Fpdf {
